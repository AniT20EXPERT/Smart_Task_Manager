...
const fs = require('fs');
// Prefer app.isPackaged to detect production; fall back to env when present
...
function createWindow() {
  ...
  // Load the app (dev: Vite server, prod: built index.html)
  if (isDev) {
  ...
  // Handle window controls for custom title bar (optional)
...
// Handle app updates (you can integrate with electron-updater here)
